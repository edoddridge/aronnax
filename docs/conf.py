# -*- coding: utf-8 -*-
#
# Aronnax documentation build configuration file, created by
...
project = u'Aronnax'
copyright = u'2017, Ed Doddridge & Alexey Radul'
author = u'Ed Doddridge & Alexey Radul'
...
latex_documents = [
    (master_doc, 'Aronnax.tex', u'Aronnax Documentation',
     u'Ed Doddridge \\& Alexey Radul', 'manual'),
]
...
man_pages = [
    (master_doc, 'aronnax', u'Aronnax Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Aronnax', u'Aronnax Documentation',
     author, 'Aronnax', 'One line description of project.',
     'Miscellaneous'),
]
